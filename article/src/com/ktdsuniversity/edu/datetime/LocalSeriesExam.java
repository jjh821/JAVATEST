...
public class LocalSeriesExam {
	...
	LocalDate birthdate = LocalDate.parse("1999-08-21");
	System.out.println(birthdate);
	int birthYear = birthdate.getYear();
	System.out.println(birthYear);
	
//	LocalDate birthdate2 = LocalDate.parse("1999년 8월 21일",
//				DateTimeFormatter.ofPattern("yyyy년 MM월 dd일"));
//	System.out.println(birthdate2);
	//오늘 날짜부터 19일 후가 언제인가
	LocalDate future = LocalDate.now().plusDays(19);
	System.out.println(future);
	//오늘 날짜부터 35년후가 몇년 몇월 몇일?
	...
	LocalDate date4 = LocalDate.parse("2026-02-05");
