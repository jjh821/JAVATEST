...
public class ExceptionExam {
	...
	public static void nullExam(String str) {
		// str이 비어있지 않으면 내용을 출력한다. 비어있으면 출력하지 않음
		// 모든 인스턴스에서 .을 사용할때 무조건 null을 체크해야하는가
		// .을 사용하려는 인스턴스가 null이  될 수 있는 가능성이 조금이라도 존재할 때만 null 체크를 한다.
	...
	//	numberFormatExam("2000");
		...
		//numberFormatExam("30000000");
		//numberFormatExam("1.1234214");
		//numberFormatExam("ㄴㅁㅎㄺㅂ");
