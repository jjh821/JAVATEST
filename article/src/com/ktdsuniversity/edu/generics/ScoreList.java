...
//							복사할 개수)
	...
	//public void sum() {
		// 배열에 들어가잇는 모든 요소들의 합을 구해 반환하려 한다.
		// 결과는 안된다.
//		T sum = 0; //T가 뭔지모르기 때문에 알 수 가없다
